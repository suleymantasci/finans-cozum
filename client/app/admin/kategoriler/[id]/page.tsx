...
function EditCategoryPageContent({ params }: { params: Promise<{ id: string }> }) {
  ...
  const loadCategory = async () => {
    try {
      setIsLoading(true)
      const data = await categoriesApi.getOne(resolvedParams.id)
      setCategory(data)
      setName(data.name)
      setSlug(data.slug)
      ...
      toast.error(error.message || 'Kategori yüklenemedi')
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await categoriesApi.update(resolvedParams.id, data)
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Kategorinin temel bilgilerini düzenleyin</CardDescription>
                </CardHeader>
